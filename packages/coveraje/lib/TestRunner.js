...
(function () {
    ...
    function TestRunner(option, instance) {
                ...
                if (ctxs[i] === "browser") {
                    if (context.window == null) {
                        try {
                            ...
                            shell.writeLine("* <color bright blue>https://github.com/tmpvar/jsdom</color>                         *");
                    ...
                    if (context.window && context.window.XMLHttpRequest == null) {
                        try {
                            ...
                            shell.writeLine("* <color bright blue>https://github.com/driverdan/node-XMLHttpRequest</color>        *");
                            shell.writeLine("***********************************************************");
                        }
                    }
                } else if (ctxs[i] === "node") {
        ...
        function run(runner, key, context, event) {
            ...
            shell.writeLine("run <color bright blue>%s</color>", key || "");
